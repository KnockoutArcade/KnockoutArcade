...
if (playerID == 1)
{
	...
	draw_text(20, 30, hasUsedAirSideSpecial);
	draw_text(20, 50, hasUsedAirDownSpecial);
	draw_text(20, 70, hasUsedAirNeutralSpecial);
	draw_text(20, 90, hasUsedAirUpSpecial);
